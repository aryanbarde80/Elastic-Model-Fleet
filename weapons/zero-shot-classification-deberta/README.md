# Zero Shot Classification Deberta API

## What this model does
Zero-shot text classification using DeBERTa. Classify text into any category without training data.
...
4. Set **Root Directory** to: `weapons/zero-shot-classification-deberta`
5. Click **"Deploy"**
