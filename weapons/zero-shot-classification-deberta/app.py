...
app = FastAPI(
    title="Zero Shot Classification Deberta API",
    description="Zero-shot text classification using DeBERTa. Classify text into any category without training data.",
    version="1.0.0"
)
