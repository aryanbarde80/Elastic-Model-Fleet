# Natural Language Inference API

## What this model does
Natural language inference: determines if a hypothesis is entailed, contradicted, or neutral given a premise.

**HuggingFace Model:** `typeform/distilbert-base-uncased-mnli`
...
4. Set **Root Directory** to: `weapons/natural-language-inference`
5. Click **"Deploy"**
