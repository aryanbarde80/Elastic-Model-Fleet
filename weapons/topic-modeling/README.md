...
Produces embeddings suitable for topic modeling pipelines like BERTopic.

**HuggingFace Model:** `sentence-transformers/all-MiniLM-L12-v2`
...
4. Set **Root Directory** to: `weapons/topic-modeling`
5. Click **"Deploy"**
