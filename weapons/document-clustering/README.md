# Document Clustering API

## What this model does
Generates high-quality embeddings for document clustering and grouping tasks.
...
4. Set **Root Directory** to: `weapons/document-clustering`
5. Click **"Deploy"**
