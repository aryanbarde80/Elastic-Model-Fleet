...
Extracts key phrases and keywords from text using a BERT-based keyword extraction model.

**HuggingFace Model:** `yanekyuk/bert-uncased-keyword-extractor`
**Task:** `ner`
...
4. Set **Root Directory** to: `weapons/keyword-extraction`
5. Click **"Deploy"**
