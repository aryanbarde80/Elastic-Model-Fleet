...
Generates embeddings optimized for semantic search and passage retrieval.

**HuggingFace Model:** `sentence-transformers/msmarco-distilbert-base-tas-b`
...
4. Set **Root Directory** to: `weapons/semantic-search`
5. Click **"Deploy"**
