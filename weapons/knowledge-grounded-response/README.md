# Knowledge Grounded Response API

## What this model does
Generates responses grounded in provided knowledge documents using Flan-T5.
...
4. Set **Root Directory** to: `weapons/knowledge-grounded-response`
5. Click **"Deploy"**
