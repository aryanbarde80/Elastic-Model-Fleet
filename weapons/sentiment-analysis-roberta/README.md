# Sentiment Analysis Roberta API

## What this model does
Sentiment analysis using RoBERTa trained on Twitter data. Classifies text as positive, negative, or neutral.
...
4. Set **Root Directory** to: `weapons/sentiment-analysis-roberta`
5. Click **"Deploy"**
