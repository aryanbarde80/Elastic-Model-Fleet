...
Scores text readability and complexity using transformer-based analysis.

**HuggingFace Model:** `agentlans/mDeBERTa-v3-base-mnli-xnli`
...
4. Set **Root Directory** to: `weapons/readability-scoring`
5. Click **"Deploy"**
