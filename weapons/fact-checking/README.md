...
Assists in fact-checking by analyzing claim veracity using RoBERTa.

**HuggingFace Model:** `consciousAI/question-answering-roberta-base-s-v2`
...
4. Set **Root Directory** to: `weapons/fact-checking`
5. Click **"Deploy"**
