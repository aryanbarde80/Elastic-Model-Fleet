...
Classifies messages as spam or ham using a tiny BERT model fine-tuned on SMS spam data.

**HuggingFace Model:** `mrm8488/bert-tiny-finetuned-sms-spam-detection`
...
4. Set **Root Directory** to: `weapons/spam-classification`
5. Click **"Deploy"**
