# Empathetic Response Generation API

## What this model does
Generates empathetic and emotionally aware responses using Flan-T5.
...
4. Set **Root Directory** to: `weapons/empathetic-response-generation`
5. Click **"Deploy"**
