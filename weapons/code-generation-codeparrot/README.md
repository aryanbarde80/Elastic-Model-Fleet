# Code Generation Codeparrot API

## What this model does
Generates Python code from natural language prompts using CodeParrot.

**HuggingFace Model:** `codeparrot/codeparrot-small`
...
4. Set **Root Directory** to: `weapons/code-generation-codeparrot`
5. Click **"Deploy"**
