# Text Matching Sentence Transformers API

## What this model does
Computes semantic similarity between text pairs using paraphrase-optimized MiniLM.

**HuggingFace Model:** `sentence-transformers/paraphrase-MiniLM-L6-v2`
...
4. Set **Root Directory** to: `weapons/text-matching-sentence-transformers`
5. Click **"Deploy"**
