# Dialogue Act Classification API

## What this model does
Classifies dialogue acts (greeting, question, statement, command) in conversational text.
...
4. Set **Root Directory** to: `weapons/dialogue-act-classification`
5. Click **"Deploy"**
