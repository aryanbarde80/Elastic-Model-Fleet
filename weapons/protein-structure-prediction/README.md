# Protein Structure Prediction API

## What this model does
Answers questions about protein structures and functions using scientific language models.
...
4. Set **Root Directory** to: `weapons/protein-structure-prediction`
5. Click **"Deploy"**
