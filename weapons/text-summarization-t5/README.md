# Text Summarization T5 API

## What this model does
Abstractive text summarization using DistilBART trained on CNN/DailyMail.
...
4. Set **Root Directory** to: `weapons/text-summarization-t5`
5. Click **"Deploy"**
