...
Resolves coreferences (pronouns and mentions referring to same entity) in text.

**HuggingFace Model:** `nielsr/coref-deberta-v3-large-first`
**Task:** `ner`
...
4. Set **Root Directory** to: `weapons/coreference-resolution`
5. Click **"Deploy"**
