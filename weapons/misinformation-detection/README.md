...
Identifies potential misinformation in social media posts and news.

**HuggingFace Model:** `hamzab/roberta-fake-news-classification`
...
4. Set **Root Directory** to: `weapons/misinformation-detection`
5. Click **"Deploy"**
