# Common Sense Reasoning API

## What this model does
Applies common-sense reasoning to answer questions using RoBERTa.

**HuggingFace Model:** `roberta-large-openai-detector`
...
4. Set **Root Directory** to: `weapons/common-sense-reasoning`
5. Click **"Deploy"**
