...
Detects hate speech targeting various demographic groups using DeHateBERT.

**HuggingFace Model:** `Hate-speech-CNERG/dehatebert-mono-english`
...
4. Set **Root Directory** to: `weapons/hate-speech-detection`
5. Click **"Deploy"**
