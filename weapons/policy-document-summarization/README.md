# Policy Document Summarization API

## What this model does
Summarizes policy documents and regulatory texts using DistilBART.

**HuggingFace Model:** `sshleifer/distilbart-cnn-6-6`
**Task:** `summarization`
...
4. Set **Root Directory** to: `weapons/policy-document-summarization`
5. Click **"Deploy"**
