# Translation En Es API

## What this model does
Translates English text to Spanish using Helsinki-NLP opus model.

**HuggingFace Model:** `Helsinki-NLP/opus-mt-en-es`
...
4. Set **Root Directory** to: `weapons/translation-en-es`
5. Click **"Deploy"**
