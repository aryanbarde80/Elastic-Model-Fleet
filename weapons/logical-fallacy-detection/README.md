...
Detects logical fallacies in argumentative text.

**HuggingFace Model:** `WinsteadZhu/bert-logical-fallacy`
...
4. Set **Root Directory** to: `weapons/logical-fallacy-detection`
5. Click **"Deploy"**
