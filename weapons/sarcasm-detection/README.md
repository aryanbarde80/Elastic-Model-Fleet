...
Detects irony and sarcasm in text using RoBERTa fine-tuned on Twitter irony data.

**HuggingFace Model:** `cardiffnlp/twitter-roberta-base-irony`
...
4. Set **Root Directory** to: `weapons/sarcasm-detection`
5. Click **"Deploy"**
