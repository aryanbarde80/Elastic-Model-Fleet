# Aspect Based Sentiment API

## What this model does
Aspect-based sentiment analysis that identifies sentiment toward specific aspects of a topic.

**HuggingFace Model:** `yangheng/deberta-v3-base-absa-v1.1`
...
4. Set **Root Directory** to: `weapons/aspect-based-sentiment`
5. Click **"Deploy"**
