# Clinical Entity Recognition API

## What this model does
Recognizes clinical entities in medical notes using BERT fine-tuned on clinical data.

**HuggingFace Model:** `samrawal/bert-base-uncased_clinical-ner`
**Task:** `ner`
...
4. Set **Root Directory** to: `weapons/clinical-entity-recognition`
5. Click **"Deploy"**
