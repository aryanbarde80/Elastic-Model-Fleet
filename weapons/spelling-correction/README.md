...
Corrects spelling errors in English text using a transformer-based spelling correction model.

**HuggingFace Model:** `oliverguhr/spelling-correction-english-base`
...
4. Set **Root Directory** to: `weapons/spelling-correction`
5. Click **"Deploy"**
