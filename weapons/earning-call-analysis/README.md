# Earning Call Analysis API

## What this model does
Analyzes earnings call transcripts for financial sentiment and key signals.
...
4. Set **Root Directory** to: `weapons/earning-call-analysis`
5. Click **"Deploy"**
