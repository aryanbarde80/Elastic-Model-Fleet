...
Detects contradictions between text pairs using a cross-encoder NLI model.

**HuggingFace Model:** `cross-encoder/nli-MiniLM2-L6-H768`
...
4. Set **Root Directory** to: `weapons/contradiction-detection`
5. Click **"Deploy"**
