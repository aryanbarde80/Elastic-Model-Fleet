# Sentence Splitting API

## What this model does
Splits text into individual sentences using transformer-aware sentence boundary detection.
...
4. Set **Root Directory** to: `weapons/sentence-splitting`
5. Click **"Deploy"**
