...
Predicts potential diagnoses from clinical notes and symptom descriptions.

**HuggingFace Model:** `uer/roberta-base-finetuned-tnews-chinese`
...
4. Set **Root Directory** to: `weapons/diagnosis-prediction`
5. Click **"Deploy"**
