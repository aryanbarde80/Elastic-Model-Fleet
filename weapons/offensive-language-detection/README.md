# Offensive Language Detection API

## What this model does
Detects offensive language in text using RoBERTa trained on Twitter data.

**HuggingFace Model:** `cardiffnlp/twitter-roberta-base-offensive`
...
4. Set **Root Directory** to: `weapons/offensive-language-detection`
5. Click **"Deploy"**
