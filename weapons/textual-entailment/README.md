# Textual Entailment API

## What this model does
Determines textual entailment relationships between sentence pairs using DeBERTa.
...
4. Set **Root Directory** to: `weapons/textual-entailment`
5. Click **"Deploy"**
