...
Extracts symptoms and clinical signs from patient descriptions and medical text.

**HuggingFace Model:** `d4data/biomedical-ner-all`
**Task:** `ner`
...
4. Set **Root Directory** to: `weapons/symptom-extraction`
5. Click **"Deploy"**
