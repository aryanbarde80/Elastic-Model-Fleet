# Punctuation Restoration API

## What this model does
Restores punctuation in unpunctuated text, useful for ASR output post-processing.

**HuggingFace Model:** `kredor/punctuate-all`
**Task:** `ner`
...
4. Set **Root Directory** to: `weapons/punctuation-restoration`
5. Click **"Deploy"**
