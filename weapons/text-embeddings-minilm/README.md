# Text Embeddings Minilm API

## What this model does
Generates dense vector embeddings for text using MiniLM. Useful for semantic similarity and search.
...
4. Set **Root Directory** to: `weapons/text-embeddings-minilm`
5. Click **"Deploy"**
