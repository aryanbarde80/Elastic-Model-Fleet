...
Analyzes morphological structure and linguistic features of words in text.

**HuggingFace Model:** `dslim/bert-large-NER`
**Task:** `ner`
...
4. Set **Root Directory** to: `weapons/morphological-analysis`
5. Click **"Deploy"**
