...
Corrects grammatical errors in text using T5 fine-tuned on grammar correction.

**HuggingFace Model:** `vennify/t5-base-grammar-correction`
...
4. Set **Root Directory** to: `weapons/grammar-correction`
5. Click **"Deploy"**
