...
Detects the stance (favor/against/neutral) of text toward a given topic.

**HuggingFace Model:** `cardiffnlp/twitter-roberta-base-stance-semeval2016t6`
...
4. Set **Root Directory** to: `weapons/stance-detection`
5. Click **"Deploy"**
