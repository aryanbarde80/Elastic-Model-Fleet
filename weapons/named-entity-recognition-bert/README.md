# Named Entity Recognition Bert API

## What this model does
Named Entity Recognition with BERT. Identifies persons, organizations, locations, and other entities in text.
...
4. Set **Root Directory** to: `weapons/named-entity-recognition-bert`
5. Click **"Deploy"**
