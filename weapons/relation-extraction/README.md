...
Extracts named entities and their relations from text using RoBERTa-large.

**HuggingFace Model:** `Jean-Baptiste/roberta-large-ner-english`
**Task:** `ner`
...
4. Set **Root Directory** to: `weapons/relation-extraction`
5. Click **"Deploy"**
