# Persuasion Strategy Detection API

## What this model does
Detects persuasion strategies and rhetorical techniques in text.
...
4. Set **Root Directory** to: `weapons/persuasion-strategy-detection`
5. Click **"Deploy"**
