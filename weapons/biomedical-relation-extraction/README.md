# Biomedical Relation Extraction API

## What this model does
Extracts relations between biomedical entities (gene-disease, drug-protein) in scientific text.

**HuggingFace Model:** `allenai/scibert_scivocab_uncased`
**Task:** `ner`
...
4. Set **Root Directory** to: `weapons/biomedical-relation-extraction`
5. Click **"Deploy"**
