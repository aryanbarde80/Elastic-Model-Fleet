...
Tags words with their part-of-speech labels using multilingual BERT.

**HuggingFace Model:** `QCRI/bert-base-multilingual-cased-pos-english`
**Task:** `ner`
...
4. Set **Root Directory** to: `weapons/part-of-speech-tagging`
5. Click **"Deploy"**
