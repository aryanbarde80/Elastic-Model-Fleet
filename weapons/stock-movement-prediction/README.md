# Stock Movement Prediction API

## What this model does
Predicts stock movement direction based on financial news sentiment using FinBERT.
...
4. Set **Root Directory** to: `weapons/stock-movement-prediction`
5. Click **"Deploy"**
