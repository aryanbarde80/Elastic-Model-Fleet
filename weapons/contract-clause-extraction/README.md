...
Extracts key clauses and provisions from legal contracts using Legal-BERT.

**HuggingFace Model:** `nlpaueb/legal-bert-base-uncased`
**Task:** `ner`
...
4. Set **Root Directory** to: `weapons/contract-clause-extraction`
5. Click **"Deploy"**
