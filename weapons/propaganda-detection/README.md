# Propaganda Detection API

## What this model does
Detects propaganda and biased framing in news and social media text.

**HuggingFace Model:** `IDA-POLITO/proppy`
...
4. Set **Root Directory** to: `weapons/propaganda-detection`
5. Click **"Deploy"**
