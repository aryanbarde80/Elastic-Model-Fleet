...
Detects the language of input text using XLM-RoBERTa. Supports 20+ languages.

**HuggingFace Model:** `papluca/xlm-roberta-base-language-detection`
...
4. Set **Root Directory** to: `weapons/language-detection`
5. Click **"Deploy"**
