...
Detects clickbait headlines and titles using BERT fine-tuned on news data.

**HuggingFace Model:** `elozano/bert-base-cased-clickbait-news`
...
4. Set **Root Directory** to: `weapons/clickbait-detection`
5. Click **"Deploy"**
