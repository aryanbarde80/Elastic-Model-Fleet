# Question Answering Distilbert API

## What this model does
Extractive question answering using DistilBERT fine-tuned on SQuAD.

**HuggingFace Model:** `distilbert-base-cased-distilled-squad`
...
4. Set **Root Directory** to: `weapons/question-answering-distilbert`
5. Click **"Deploy"**
