...
Detects whether two sentences are paraphrases of each other.

**HuggingFace Model:** `shahrukhx01/paraphrase-mpnet-base-v2-finetune-paraphrase`
...
4. Set **Root Directory** to: `weapons/paraphrase-detection`
5. Click **"Deploy"**
