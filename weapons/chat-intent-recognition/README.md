# Chat Intent Recognition API

## What this model does
Recognizes user intent in chat messages for conversational AI systems.
...
4. Set **Root Directory** to: `weapons/chat-intent-recognition`
5. Click **"Deploy"**
